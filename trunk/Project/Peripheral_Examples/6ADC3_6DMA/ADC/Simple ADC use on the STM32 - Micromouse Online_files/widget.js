...
var scr = document.getElementById('pulsemaps_343357973');


var a = document.createElement('a');
a.href = location.protocol + '//pulsemaps.com/maps/343357973/';
...
div.id = 'pulsemaps_div_343357973';
div.style.width = '210px';
div.style.height = '117px';
div.style.padding = '0px';
div.style.border = '0px';
div.style.backgroundColor = '#0b0a32';
div.style.backgroundImage = 'url(' + location.protocol + '//pulsemaps.com/static/maps/satellite-map3-210.jpg)';
...
ovl.style.backgroundImage = 'url(' + location.protocol + '//pulsemaps.com/widget.png?id=343357973&c4=ff0000&c5=ffff00&c6=ffffff&width=210)';
...
meta.id = 'pulsemaps_meta_343357973';
...
pulsemaps.recent = function(recent) {
    ...
    hit.style.left = Math.round(recent.x * 210 - 4) + 'px';
    hit.style.top = Math.round(recent.y * 210 + 1) + 'px';
    hit.style.zIndex = 1;
    div.appendChild(hit);
}
...
scr.src = location.protocol + '//pulsemaps.com/t/recents.js?id=343357973';
