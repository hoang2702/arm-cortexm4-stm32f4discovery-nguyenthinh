...
// Vi du: Truyen cho visme khoang cach 23 => Frame: 5xx23
			else if(select==5)
			{
				...
				MSD_SenCmd(12,1, -1000*(data+Calib_2));
				MSD_SenCmd(13,1, -1000*(data+Calib_3));
				MSD_SenCmd(14,1, -1000*(data+Calib_4));
				MSD_SenCmd(15,1, -1000*(data+Calib_5));
				MSD_SenCmd(16,1, -1000*(data+Calib_6));
				
				ViTri_Visme_Desire[0]=data+83+Calib_1;
				ViTri_Visme_Desire[1]=data+83+Calib_2;
				ViTri_Visme_Desire[2]=data+83+Calib_3;
				ViTri_Visme_Desire[3]=data+83+Calib_4;
				ViTri_Visme_Desire[4]=data+83+Calib_5;
				ViTri_Visme_Desire[5]=data+83+Calib_6;
